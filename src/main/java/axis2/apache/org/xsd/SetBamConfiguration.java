...
@XmlRootElement(name = "setBamConfiguration")
public class SetBamConfiguration {
    ...
    @XmlElementRef(name = "value", namespace = "http://org.apache.axis2/xsd", type = JAXBElement.class, required = false)
